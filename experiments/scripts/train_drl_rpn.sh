...
case ${DATASET} in
  pascal_voc_0712_test)
    SAVE_PATH=checkpoints/output-weights/drl-rpn-voc2007-2012-trainval+2007test/
    case ${USE_POST} in
      0)
        WEIGHTS_PATH=checkpoints/fr-rcnn-voc2007-2012-trainval+2007test/vgg16_2012_faster_rcnn_iter_180000.ckpt
        ;;
      *)
        WEIGHTS_PATH=checkpoints/drl-rpn-voc2007-2012-trainval+2007test/vgg16_2012_drl_rpn_iter_110000.ckpt
        ;;
    esac
    ;;
  *)
    SAVE_PATH=checkpoints/output-weights/drl-rpn-voc2007-2012-trainval/
    case ${USE_POST} in
      0)
        WEIGHTS_PATH=checkpoints/fr-rcnn-voc2007-2012-trainval/vgg16_faster_rcnn_iter_180000.ckpt
        ;;
      *)
        WEIGHTS_PATH=checkpoints/drl-rpn-voc2007-2012-trainval/vgg16_drl_rpn_iter_110000.ckpt
        ;;
    esac
    ;;
esac
