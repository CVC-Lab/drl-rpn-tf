...
case ${DATASET} in
  pascal_voc_0712_test)
    WEIGHTS_PATH=./data/drl-rpn-voc2007-2012-trainval-plus-2007test/vgg16_2012_drl_rpn_iter_110000.ckpt
    ;;
  *)
    WEIGHTS_PATH=./data/drl-rpn-voc2007-2012-trainval/vgg16_drl_rpn_iter_110000.ckpt
    ;;
esac
